...
class PostSpider(object):
    ...
    def spider_post_info(self, page1: int, page2: int):
...
def post_thread(stock_code, start_page, end_page):
    """帖子爬取线程函数:stock_code为股票的代码,page为想要爬取的页面范围"""
    post_spider = PostSpider(stock_code)
    post_spider.spider_post_info(start_page, end_page)
